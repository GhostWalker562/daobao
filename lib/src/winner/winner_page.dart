                      ...
                      return state.when(
                        ...
                        decided: (prop, addy) {
                          return Column(
                            ...
                            children: [
                              Lottie.network(
                                'https://assets1.lottiefiles.com/packages/lf20_naa8hmmn.json',
                                height: 200,
                              ),
                              SelectableText(
                              ...
                              BlocProvider(
                                ...
                                child: BlocBuilder<SendNftCubit, SendNftState>(
                                  builder: (context, state) {
                                          ...
                                          return TransparentButton(
                                            ...
                                            child: Container(
                                              ...
                                              margin: const EdgeInsets.only(
                                                  right: 12),
                                              child: Text(
                                                'APPRECIATED ${addy.substring(0, 5)}...${addy.substring(addy.length - 5)}',
                                                style: TextStyle(
                                                  color: context
